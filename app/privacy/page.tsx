    ...
    <main className="section">
      <div className="container max-w-3xl premium-card rounded-[30px] p-6 sm:p-8">
        ...
        <div className="mt-8 space-y-5 text-brand-muted">
          ...
          <p>Les demandes transmises via le site servent uniquement a traiter votre prise de contact. Pour une exploitation avancee, elles peuvent etre reliees a un CRM, une base de donnees ou une API email.</p>

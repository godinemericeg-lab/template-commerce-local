...
export const siteTemplates = {
  barber: {
    ...
    seo: {
      ...
      canonicalUrl: "https://demo-commerce-local.vercel.app",
  ...
  garagiste: {
    ...
    services: [
      { id: "revision", name: "Revision complete", description: "Vidange, filtres, points de controle et rapport.", priceFrom: 129, duration: "2 h", popular: true, keywords: ["revision", "vidange", "entretien", "filtre"] },
      { id: "freinage", name: "Freinage", description: "Plaquettes, disques et purge selon diagnostic.", priceFrom: 89, duration: "1 h 30", keywords: ["frein", "plaquettes", "disques", "freinage"] },
      { id: "diagnostic", name: "Diagnostic electronique", description: "Lecture defauts et recommandation claire.", priceFrom: 49, duration: "45 min", keywords: ["diagnostic", "voyant", "panne", "valise"] }
    ],
    hours: commonHours,
    reviews: [
    ...
    faq: [
      { question: "Puis-je obtenir un devis avant reparation ?", answer: "Oui, chaque intervention est validee avec vous avant demarrage." },
      { question: "Prenez-vous les urgences ?", answer: "Nous gardons des creneaux pour les diagnostics urgents selon disponibilite." }
    ],
    seo: {
    ...
    form: { needLabel: "Intervention souhaitee", dateLabel: "Date souhaitee", messagePlaceholder: "Ex : voyant moteur allume, Peugeot 208, 2018" }
  },
  plombier: {
    template: "plombier",
